...
function Header() {
  ...
  const items = [
    { label: "Home", to: "/", key: "" },
    { label: "Catalog", to: "/catalog", key: "tmp-1" },
    { label: "Contact", to: "/contact", key: "tmp-2" },
  ];
  ...
  useEffect(() => {
    ...
    if (locationPart === "/catalog") {
      setCurrent("tmp-1");
    }
    if (locationPart === "/contact") {
      setCurrent("tmp-2");
    }
    if (locationPart === "/flora-flower-gift") {
      navigate("/");
    }
  }, [location]);
  const onClick = (event) => {
          ...
          <div className='wrapper-search'>
            ...
            <div className='search-icon-result'>
              <svg
                ...
                height='16'
                fill='currentColor'
                class='bi bi-search search-icon-input-results'
                viewBox='0 0 16 16'
              >
